    ...
    switch (_obj.content) {
        case message.buttons[0]:
            axios.all([
                ...
                console.log(JSON.stringify(upbitKRWRes));
                console.log(JSON.stringify(bitfinexUSDRes));
        ...
        case message.buttons[1]:
            axios.all([
                ...
                console.log(JSON.stringify(binanceBTCRes));
                console.log(JSON.stringify(binanceETHRes));
                console.log(JSON.stringify(coinnestKRWRes));
